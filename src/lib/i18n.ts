...
evo_inspector: " 增量记忆解构审查",
  evo_inspect_node: "审查节点",
evo_hallucination_trace: " 幻觉/报错触发轨迹",
...
chat_welcome_demo: " Chronos-Shadow 守护引擎加载成功。 未配置 API Key，当前为演示模式。请在「全局配置」中填入 API 密钥以启用真实对话。",
...
security_redlines: " Security Redlines & Sandbox",
...
evo_error_log: " Shadow Delta Error Log",
  ...
  evo_aura_connected: "Evolution Aura: Connected",
evo_inspector: " Memory Inspector",
  evo_inspect_node: "Inspect Node",
evo_hallucination_trace: " Hallucination/Error Trigger Trace",
...
chat_welcome_demo: " Chronos-Shadow engine loaded. No API Key configured — demo mode. Go to Settings to enter API credentials for live AI chat.",
...
settings_security: " Security & Sandbox",
