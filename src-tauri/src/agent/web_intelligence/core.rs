// WebIntelligence 核心实现（白名单/搜索/抓取/研究/审计/持久化）
use std::collections::HashMap;
use crate::agent::distillation_engine::{DistillationEngine, DistillationLevel, ContentFragment, EntityType};
use crate::agent::cache_engine::{UnifiedCache, CacheCategory};
...
impl WebIntelligence {
    ...
    pub fn sync_to_evolution_bus(&mut self, bus: &mut EvolutionBus) {
        use crate::agent::evolution_bus::EngineId;
